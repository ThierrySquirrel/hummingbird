...
/**
 * Classname: FormUrlencodedFactory
 * Description:
 ...
 * @since JDK 11
 */
public class FormUrlencodedFactory {
    private FormUrlencodedFactory() {
    }

    public static void putText(ByteBufferFacade byteBufferFacade, String key, String value) {
        byteBufferFacade.putString (UrlCoderFactory.encoder (key));
        byteBufferFacade.putString (UrlCoderConstant.EQUALS_SIGN);
        byteBufferFacade.putString (UrlCoderFactory.encoder (value));
    }
}
