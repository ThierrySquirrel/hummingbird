 ...
 **/
package io.github.thierrysquirrel.hummingbird.core.extend.http.core.coder.client;

import io.github.thierrysquirrel.hummingbird.core.coder.HummingbirdEncoder;
import io.github.thierrysquirrel.hummingbird.core.extend.http.core.coder.factory.HttpEncoderFactory;
 ...
 * @since JDK21
 **/
public class HttpClientEncoder implements HummingbirdEncoder<HttpRequestContext> {
    @Override
    public void encoder(HttpRequestContext message, ByteBufferFacade byteBufferFacade) {
        HttpEncoderFactory.encoderHttpRequest(byteBufferFacade, message);
